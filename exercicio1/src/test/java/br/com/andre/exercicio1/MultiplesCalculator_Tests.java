...
class MultiplesCalculator_Tests {
    ...
    public @Test void until_Returns_A_Calculation_Result_Object() {
    ...
    public @Test void Calling_getBaseOperands_Returns_An_Array() {
    ...
    public @Test void Instancing_MultiplesCalculator_Without_Operands_Throws_Exception() {
    ...
    public @Test void Passing_Zero_As_Operand_Throws_Exception() {
        Exception e1 = assertThrows(IllegalArgumentException.class, () -> {
